...
**Status:** v0.1.0 in development. All Bloodcraft tabs functional (8 tabs). KindredCommands / KindredLogistics integration in progress. Not yet published to Thunderstore.
...
- **Tabbed primary UI** with 3 collapsible groups in the left rail:
  ...
  - **KINDRED**: (coming soon — KindredLogistics + KindredCommands integration)
